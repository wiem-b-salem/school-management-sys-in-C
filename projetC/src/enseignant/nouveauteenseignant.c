#include <stdio.h>
#include "../../header/enseignant/nouveauteenseignant.h"

// Fonction pour afficher les nouveaut�s de l'enseignant
...
// Fonction pour charger les nouveaut�s sp�cifiques � l'enseignant
NouveauteEnseignant chargerNouveautesEnseignant() {
    ...
    for (i = 0; i < 5; i++) {
        nouveaute.notes[i] = 10 + i;  // Notes fictives pour 5 mati�res
    }
